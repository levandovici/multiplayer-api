...
try {
    ...
    error_log("Leaderboard SQL (Unity): " . $sql);
    ...
    // Build response with ranks - Unity compatibility: player_data as JSON string
    $leaderboard = [];
    $rank = 1;
    ...
    foreach ($players as $row) {
        ...
        $leaderboard[] = [
            ...
            'player_data_json' => json_encode($playerData, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES), // Unity compatibility
        ];
    }
