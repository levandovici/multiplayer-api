<?php
// time.php – Unity compatible version
...
// Log the request
error_log("=== Time API Request (Unity) ===");
...
try {
    ...
    // Return time data - Unity compatible (no objects, all primitive types)
    $response = [
        'success' => true,
        'utc' => $utc,
        'timestamp' => $timestamp,
    ...
    error_log("Time API Error (Unity): " . $e->getMessage());
