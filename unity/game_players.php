...
try {
    ...
    switch ($endpoint) {
        ...
        case 'login':
            ...
            // Unity compatibility: Convert player_data to JSON string
            $player['player_data_json'] = json_encode($playerData, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES);
    ...
    error_log('Error in game_players.php (Unity): ' . $e->getMessage());
    sendResponse([
        'success' => false,
