<?php
$title = "Mumbai Server – Multiplayer API";
$description = "Standby server in Mumbai, India - Ready for deployment when clients require it.";
...
<body class="min-h-screen animated-bg">
    ...
    <section class="relative py-32 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-6 lg:px-8 text-center">
            ...
            <p class="text-2xl text-white/80 mb-4">bom.michitai.com</p>
