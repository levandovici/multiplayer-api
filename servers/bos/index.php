<?php
$title = "Boston Server – Multiplayer API";
$description = "Standby server in Boston - Ready for deployment when clients require it.";
...
<body class="min-h-screen animated-bg">
    ...
    <section class="relative py-32 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-6 lg:px-8 text-center">
            ...
            <p class="text-2xl text-white/80 mb-4">bos.michitai.com</p>
            <p class="text-xl text-white/60 mb-12 max-w-2xl mx-auto">
                Boston - This server is on standby and can be quickly deployed when clients require it.
            </p>
