...
<head>
    ...
    <title>Login - Multiplayer API</title>
...
<body class="min-h-screen animated-bg">
        ...
        <div class="w-full max-w-md">
            <div class="glass-effect rounded-2xl p-8 shadow-xl">
                <div class="text-center mb-8">
                    <div class="w-16 h-16 rounded-full bg-gradient-to-r from-purple-600 to-pink-600 flex items-center justify-center mx-auto mb-4">
                ...
                <form action="php/login.php" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-2 text-right">
                            <a href="#" class="text-xs text-purple-300 hover:text-white hover:underline">Forgot password?</a>
                        </div>
                    </div>
                    
                    <div class="flex items-center">
                        <input id="remember-me" name="remember-me" type="checkbox" class="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-600 rounded bg-white/5">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const formElements = document.querySelectorAll('input, button, a, .glass-effect');
