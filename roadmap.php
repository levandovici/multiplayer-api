...
$title = "Development Roadmap - Multiplayer API";
$description = "Track the development progress and analytics of the Multiplayer API project.";
    ...
    <section class="relative py-16 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-6 lg:px-8 text-center">
            ...
            <p class="text-xl text-white/80 mb-8">
                Track our progress and development analytics
            </p>
            <a href="index.php" class="btn-primary text-white px-8 py-3 rounded-xl font-semibold inline-flex items-center">
